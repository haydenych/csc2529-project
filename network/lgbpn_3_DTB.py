...
@regist_model
class DTB_2_branches(nn.Module):

    def __init__(self, in_ch=3, out_ch=3, base_ch=128, num_module=9, pattern='baseline', group=1, head_ch=None, br2_blc=3, SIDD=True):
        '''
        Args:
        ...
        self.branch1 = local_branch(2, base_ch, num_module=[br2_blc], group=group, head_ch=head_ch, SIDD=SIDD)
